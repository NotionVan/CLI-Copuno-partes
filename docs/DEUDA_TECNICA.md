...
| 2026-05-28 | Claude Code | **v1.2.2 — rectificativos desde `Datos Enviados`.** El botón "Rectificar" del listado ahora aparece también en partes `Datos Enviados`, no solo `Firmado`. `PARTE_RECTIFICABLES = ['firmado','datos enviados']` (backend + mock + UI). Changelog `CHANGELOG_V1.2.2.md`. |
