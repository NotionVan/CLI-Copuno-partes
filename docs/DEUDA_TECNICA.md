...
- **Última edición:** 2026-05-28 (v1.2.2 — rectificativos también desde `Datos Enviados` (antes solo `Firmado`). Previo v1.2.1: fix nombres de propiedad con espacio final, prefijo "PARTE RECTIFICATIVO" en notas, modal de confirmación, banner a 1 min. N6 Make sigue pendiente)
...
| 2026-05-28 | Claude Code | **v1.2.2 — rectificativos desde `Datos Enviados`.** El botón "Rectificar" del listado ahora aparece también en partes `Datos Enviados`, no solo `Firmado`. `PARTE_RECTIFICABLES = ['firmado','datos enviados']` (backend + mock + UI). Verificado en producción (QA Chrome) sobre un parte `Datos Enviados` real: flujo completo OK, sin errores. Changelog `CHANGELOG_V1.2.2.md`. |
