...
- **Última edición:** 2026-05-28 (v1.2.1 — rectificativos verificados en producción (fix nombres de propiedad con espacio final + prefijo "PARTE RECTIFICATIVO" en notas + modal de confirmación) y banner de actualización a 1 min. N6 Make sigue pendiente)
