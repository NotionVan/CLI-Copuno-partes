...
### P4 🟡 — `empleados.listarTodos` pagina sin retry de 429 ni guard de petición en vuelo
...
**Recomendación:** retainer, dentro de la bolsa de soporte de agosto o en el primer ciclo de
septiembre. No es hotfix: no rompe ningún flujo crítico.
